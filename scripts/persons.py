...
index_file = "./emt-listperson.xml"
entity_type = "person"

print("check if source file exists")
BASE_URL = "https://raw.githubusercontent.com/emt-project/emt-entities/refs/heads/main/indices/"  # noqa
...
for x in tqdm(items, total=len(items)):
    ...
    try:
        ...
        event_graph, birth_uri, birth_timestemt = make_birth_death_entities(
            subj,
            x,
            f"{PU}",
            event_type="birth",
    ...
    try:
        ...
        event_graph, death_uri, birth_timestemt = make_birth_death_entities(
            subj,
            x,
            f"{PU}",
            event_type="death",
...
save_path = os.path.join(rdf_dir, f"emt_{entity_type}.nt")
